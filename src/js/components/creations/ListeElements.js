...
export default function ListeElements() {
    ...
    return <ul className="listeElements" onClick={ clickHandler }>
        ...
        <li><Element type="radio" valeurs={["Choix 1", "Choix 2", "Choix 3"]} onClick={clickHandler} selected={elementSelected} /></li>
        <li><Element type="checkbox" valeurs={["Choix 1", "Choix 2", "Choix 3"]} onClick={clickHandler} selected={elementSelected} /></li>
